    ...
    return (
        <aside className="hidden md:flex flex-col w-64 h-screen bg-black/90 border-r border-white/10 fixed left-0 top-0 z-50 backdrop-blur-xl">
            ...
            <div className="p-8 flex items-center gap-3">
                ...
                <h1 className="font-display font-bold text-xl tracking-wider uppercase"><span className="bg-gradient-to-r from-white via-[#FFD6BC] to-[#D6582C] bg-clip-text text-transparent">Celest AI</span></h1>
            </div>
