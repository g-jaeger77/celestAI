                ...
                <div className="bg-[#2a1e1a] rounded-2xl border border-primary p-1 shadow-[0_0_40px_rgba(214,88,46,0.15)] overflow-hidden">
                    <div className="bg-[#201613] rounded-xl p-6 md:p-10 relative overflow-hidden">
                        ...
                        <button
                            onClick={handleStart}
                            disabled={loading}
                            className="w-full bg-primary hover:bg-primary/90 text-white font-bold text-lg py-4 rounded-xl shadow-lg shadow-primary/25 transition-all hover:scale-[1.02] flex items-center justify-center gap-2 mb-4 group disabled:opacity-50 disabled:cursor-not-allowed"
                        >
                            {loading ? (
